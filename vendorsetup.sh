...
git clone --depth=1 https://github.com/gregoorr/android_device_xiaomi_sm8350-common -b RisingOS device/xiaomi/sm8350-common

# Kernel
echo 'Cloning Kernel tree'
git clone --depth=1 https://github.com/gregoorr/android_kernel_xiaomi_sm8350 -b lineage-20 kernel/xiaomi/sm8350
...
git clone --depth=1 https://github.com/gregoorr/proprietary_vendor_xiaomi_haydn -b lineage-20 vendor/xiaomi/haydn

# Vendor common
echo 'Cloning Common vendor tree'
git clone --depth=1 https://github.com/gregoorr/proprietary_vendor_xiaomi_sm8350-common -b lineage-20 vendor/xiaomi/sm8350-common
